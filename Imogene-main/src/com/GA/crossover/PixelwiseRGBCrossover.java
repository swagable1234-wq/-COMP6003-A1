...
/**
 * Pixel-wise crossover function mixes pixels from both parent images.
 * Each pixel has a 50% to be selected from the first image and 50%
 * from the second.
 *
 * Weighted option changes these probabilities to be proportional to
 * the fitnesses of the images, so that the child image inherits
 * more pixels from the fitter parent.
 *
 */
